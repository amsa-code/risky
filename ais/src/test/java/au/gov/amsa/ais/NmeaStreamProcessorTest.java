...
public class NmeaStreamProcessorTest {
    ...
    public void testStreamHasNoTimestampsAtStart() {
        NmeaStreamProcessor p = new NmeaStreamProcessor(TstUtil.createLoggingListener(System.out),
                true);
        p.line("!BSVDM,1,1,0,1,53F=qV02>n<<D<`H001A8tpTt00000000000000N3`J384V<t=PhD1H53mkP00000000000,2*67",
                1328133720012L);
        p.line("!AIVDM,1,1,,A,144gjIP0085KKPQHMPjT81Sb1PSL,0*22", 1328133720087L);
        p.line("$PGHP,1,2012,2,1,20,19,5,651,316,2,316000002,1AIS_S,22*4B", 1328133720089L);
        p.line("!BSVDM,1,1,0,1,544gjIP2209mD<e`0004d4@DlTf0HD@u8uH0001J8Q9D44a8tE0hD1H53mkP00000000000,2*75",
                1328133720096L);
        p.line("!AIVDM,1,1,,A,13F=qV8P1L5GG8QK6<JKHOv02HRu,0*6D", 1328133720097L);
    ...
    public void testMultipleChecksumMatchesFoundToTimestamp() {
        ...
        p.line("$PGHP,1,2012,2,1,20,19,5,651,316,2,316000002,1AIS_S,22*4B", 111111111111111L);
        // first line will have expired
    ...
    public void testMultipleChecksumMatchesFoundToTimestampLaterMessageCloser() {
        ...
        // much later to expire the buffer
        p.line("$PGHP,1,2012,2,1,20,19,5,651,316,2,316000002,1AIS_S,22*4B", 111111111111111L);
        p.line("!AIVDM,1,1,,A,13F=qV8P1L5GG8QK6<JKHOv02HRu,0*6D", 111111111111111L);
        // first line will have expired
    ...
    public void testStreamReportsNmeaLineWithoutBufferingIfMatchWithTimestampLineIsFalse() {
        ...
        assertEquals(time, (long) recorder.getTimestampsFound().get(0).getRight());
    }
    ...
    public void testFullMessageGroupWithTimestampOnFirstLineIsReturnedAggregated() {
        ...
        p.line(line2, 2);
        assertEquals(1, recorder.getTimestampsFound().size());
        assertEquals(1334278696000L, (long) recorder.getTimestampsFound().get(0).getRight());
    }
    ...
    public void testMultiSequenceMessageWithoutTagBlock() {
        ...
        assertEquals(23L, (long) recorder.getTimestampsFound().get(0).getRight());
    }
    ...
    private static class NmeaStreamProcessorListenerRecording implements
        ...
        private final List<Pair<String, Long>> invalidNmea = Lists.newArrayList();
    ...
    public static void main(String[] args) {
        ...
        TstUtil.process(con, TstUtil.createLoggingListener(System.out), System.out);
    }
