 ...
 * @version $Id$
 */
public class AnimatorMapFrame extends JFrame {
    ...
    private static void doShowMap(MapContent content) {
        final AnimatorMapFrame frame = new AnimatorMapFrame(content, null);
     ...
     *            the map content
     */
    public AnimatorMapFrame(MapContent content, GTRenderer renderer) {
     ...
     * all {@link AnimatorMapFrame.Tool} constants.
     * 
     * @param enabled
     ...
     * {@link AnimatorMapFrame.Tool} constants.
     * 
     * <code><pre>
     ...
     *
     * @param enabled
     *            whether the map layer table is required.
     */
    ...
    public void initComponents() {
        ...
        JPanel panel = new JPanel(new MigLayout("wrap 1, insets 0", // layout
                                                                    // constrains:
                                                                    // 1
                                                                    // component
                                                                    // per row,
         ...
         * resetting the map to its full extent. The cursor tool buttons
        ...
        if (showLayerTable) {
            ...
            /*
             * We put the map layer panel and the map pane into a JSplitPane so
             ...
             * effect of setting the initial position of the JSplitPane divider
             */
