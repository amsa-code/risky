...
public class Util {
	...
	public static String memoryUsage() {
		...
		return "usedHeap=" + (used / 1000000) + "MB, percent="
				+ (100.0 * used / r.maxMemory());
	}
	...
	public static Observable<File> getFiles(String directory,
			final String startsWith) {
		return from(new File(directory).listFiles(new FileFilter() {
			@Override
