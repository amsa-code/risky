...
public class SegmentOptions {
	...
	private SegmentOptions(Long acceptAnyFixAfterHours,
			double speedCheckDistanceThresholdNm, long speedCheckMinTimeDiffMs,
			double maxSpeedKnots, Double maxDistancePerSegmentNm,
	...
	public static class Builder {
		...
		public Builder speedCheckDistanceThresholdNm(
				double speedCheckDistanceThresholdNm) {
			this.speedCheckDistanceThresholdNm = speedCheckDistanceThresholdNm;
			return this;
		}
		...
		public SegmentOptions build() {
			return new SegmentOptions(acceptAnyFixHours,
					speedCheckDistanceThresholdNm, speedCheckMinTimeDiffMs,
					maxSpeedKnots, maxDistancePerSegmentNm, maxTimePerSegmentMs);
		}
	}
}