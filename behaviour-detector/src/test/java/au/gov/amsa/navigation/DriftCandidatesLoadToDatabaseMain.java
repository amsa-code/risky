...
public class DriftCandidatesLoadToDatabaseMain {
    ...
    public static void main(String[] args) {
        ...
        Observable<Object> candidates = DriftCandidates
        // load drift candidates from csv
                ...
                .flatMap(new Func1<DriftCandidate, Observable<Object>>() {
                    ...
                    public Observable<Object> call(DriftCandidate c) {
                        ...
                        // return a vector of parameters to be inserted into the
                        // table
                        return Observable.<Object> just(f.mmsi(), new Date(f.time()), f.lat(), f
                                .lon(), f.courseOverGroundDegrees().get(),
                                f.headingDegrees().get(), f.aisClass().name(), navStatus,
                                driftingSince);
                    }
                });
