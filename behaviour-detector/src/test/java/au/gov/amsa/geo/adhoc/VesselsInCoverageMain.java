...
public class VesselsInCoverageMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(
            ...
            Observable.from(list) //
                    ...
                    .flatMap(files -> toFixes(files, Schedulers.computation())) //
    ...
    private static Observable<Fix> toFixes(GroupedObservable<Integer, File> files,
            Scheduler scheduler) {
        return files //
