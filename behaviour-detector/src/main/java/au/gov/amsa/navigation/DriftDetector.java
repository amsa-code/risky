...
public class DriftDetector {
	...
	public static class DriftDetectorTransformer implements
			Transformer<HasFix, DriftCandidate> {
		...
		public Observable<DriftCandidate> call(Observable<HasFix> o) {
			return d.getCandidates(o, options)
					.lift(Operators.bufferEmissions());
		}
	}
