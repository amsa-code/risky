...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.codecogs.com/eqnedit.php?latex=\fn_jvn&space;weight\&space;w_i(t)&space;=&space;\frac{1}{\sigma_i^2&space;.&space;(\frac{d_i(t)}{\mu_{speed}&space;&plus;&space;2\sigma_{speed}}&space;&plus;&space;|t-t_i|)^2}\newline\newline&space;\indent" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\fn_jvn&space;weight\&space;w_i(t)&space;=&space;\frac{1}{\sigma_i^2&space;.&space;(\frac{d_i(t)}{\mu_{speed}&space;&plus;&space;2\sigma_{speed}}&space;&plus;&space;|t-t_i|)^2}\newline\newline&space;\indent" title="weight\ w_i(t) = \frac{1}{\sigma_i^2 . (\frac{d_i(t)}{\mu_{speed} + 2\sigma_{speed}} + |t-t_i|)^2}\newline\newline \indent" /></a>
