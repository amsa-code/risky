...
public class Ship {
	...
	private Ship(String imo, Optional<String> mmsi, Optional<String> type2,
			Optional<String> type3, Optional<String> type4,
			Optional<String> type5, Optional<Long> grossTonnage,
			Optional<String> classificationSocietyCode,
			Optional<String> flagCode,
			...
			Optional<DateTime> lastUpdateTime) {
	...
	public static class Builder {
		...
		public Builder classificationSocietyCode(
				Optional<String> classificationSocietyCode) {
			this.classificationSocietyCode = classificationSocietyCode;
			return this;
		}
		...
		public Ship build() {
			return new Ship(imo, mmsi, type2, type3, type4, type5,
					grossTonnage, classificationSocietyCode, flagCode,
					groupBeneficialOwnerCompanyCode,
					groupBeneficialOwnerCountryOfDomicileCode,
					countryOfBuildCode, yearOfBuild, monthOfBuild,
					deadweightTonnage, statCode5, lengthOverallMetres,
					breadthMetres, displacementTonnage, draughtMetres,
					speedKnots, lastUpdateTime);
		}
	}
